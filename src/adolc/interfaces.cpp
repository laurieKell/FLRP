...
{ /* olvo 980729 general ec */
    ...
    if (m == 1) {
        ...
        Rprintf("ADOL-C error: wrong Y dimension in forward \n");
...
{ int rc = -1;
    ...
    if (d != 0) {
        Rprintf("ADOL-C error:  wrong X and Y dimensions in forward \n");
        adolc_exit(-1,"",__func__,__FILE__,__LINE__);
    } else
        rc = zos_forward(tag,m,n,keep,X,Y);
...
{ int rc=-1;
    ...
    if (m != 1) {
        Rprintf("ADOL-C error:  wrong u dimension in scalar-reverse \n");
        adolc_exit(-1,"",__func__,__FILE__,__LINE__);
    } else
...
{ if (d != 0) {
        Rprintf("ADOL-C error:  wrong Z dimension in scalar-reverse \n");
        adolc_exit(-1,"",__func__,__FILE__,__LINE__);
    }
...
{ int rc=-1;
    ...
    if (m != 1 || d != 0 ) {
        Rprintf("ADOL-C error:  wrong u or Z dimension in scalar-reverse \n");
        adolc_exit(-1,"",__func__,__FILE__,__LINE__);
    } else
...
{ int rc=-1;
    ...
    if (m != 1) {
        Rprintf("ADOL-C error:  wrong U dimension in vector-reverse \n");
        adolc_exit(-1,"",__func__,__FILE__,__LINE__);
    } else { /* olvo 980727 ??? */
...
{ int rc=-1;
    ...
    if (d != 0) {
        Rprintf("ADOL-C error:  wrong degree in vector-reverse \n");
        adolc_exit(-1,"",__func__,__FILE__,__LINE__);
    } else
