...
protected:
    ...
    explicit adubref( void ) {
        Rprintf("ADOL-C error: illegal default construction of adubref"
                " variable\n");
        exit(-2);
    }
    explicit adubref( double ) {
        Rprintf("ADOL-C error: illegal  construction of adubref"
    ...
    adubref( const adubref& ) {
        Rprintf("ADOL-C error: illegal copy construction of adubref"
               " variable\n");
        exit(-2);
    }
